...
//
//    @PersistenceContext // annotation is used to indicate that the class provides the mechanism for storage, retrieval, search, update and delete
...
public class UserDAOImpl implements UserDAO {
...

    {
        ...
        users.add(new User(++PEOPLE_COUNT, "Volga", "1968", "85"));
        users.add(new User(++PEOPLE_COUNT, "Vladimir", "Evtushenko", "42"));
        users.add(new User(++PEOPLE_COUNT, "Moskvich", "1976", "65"));
        users.add(new User(++PEOPLE_COUNT, "Kombi", "1973", "70"));
    }
